...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help") || gArgs.IsArgSet("-version"))
    {
        ...
        std::string strUsage = strprintf(_("%s curvehash-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  curvehash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded curvehash transaction") + "\n" +
              "  curvehash-tx [options] -create [commands]   " + _("Create hex-encoded curvehash transaction") + "\n" +
              "\n";
        ...
        strUsage += HelpMessageOpt("replaceable(=N)", _("disabled, left for rpc backward compatibility"));
