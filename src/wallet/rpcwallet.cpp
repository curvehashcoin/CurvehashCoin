...
UniValue getnewaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nReturns a new Curvehash address for receiving payments.\n"
            ...
            "\nResult:\n"
            "\"address\"    (string) The new curvehash address\n"
            "\nExamples:\n"
...
UniValue getaccountaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nDEPRECATED. Returns the current Curvehash address for receiving payments to this account.\n"
            "\nArguments:\n"
            "1. \"account\"       (string, required) The account name for the address. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created and a new address created  if there is no account by the given name.\n"
            "\nResult:\n"
            "\"address\"          (string) The account curvehash address\n"
            "\nExamples:\n"
...
UniValue getrawchangeaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            ...
            "\nReturns a new Curvehash address, for receiving change.\n"
...
UniValue setaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The curvehash address to be associated with an account.\n"
    ...
    if (!IsValidDestination(dest)) {
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Curvehash address");
    }
...
UniValue getaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The curvehash address for account lookup.\n"
            "\nResult:\n"
...
UniValue getaddressesbyaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "  \"address\"         (string) a curvehash address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
...
static void SendMoney(CWallet * const pwallet, const CTxDestination &address, CAmount nValue, bool fSubtractFeeFromAmount, CWalletTx& wtxNew, const CCoinControl& coin_control)
{
    ...
    if (fWalletUnlockStakeOnly)
        throw JSONRPCError(RPC_WALLET_ERROR, "Error: Wallet unlocked for block staking only, unable to create transaction.");
...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"            (string, required) The curvehash address to send to.\n"
            ...
            "                             The recipient will receive less curvehashs than you enter in the amount field.\n"
            "6. replaceable            (boolean, optional) disabled, left for rpc backward compatibility\n"
            "7. conf_target            (numeric, optional) Confirmation target (in blocks)\n"
            "\nResult:\n"
            "\"txid\"                  (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"PN9ZrKwPttJxM8VMsfBFtAWzbycpG2cosD\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"PN9ZrKwPttJxM8VMsfBFtAWzbycpG2cosD\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"PN9ZrKwPttJxM8VMsfBFtAWzbycpG2cosD\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"PN9ZrKwPttJxM8VMsfBFtAWzbycpG2cosD\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue listaddressgroupings(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"address\",            (string) The curvehash address\n"
...
UniValue signmessage(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2)
        throw std::runtime_error(
            ...
            + HelpRequiringPassphrase(pwallet) + "\n"
            "\nArguments:\n"
            "1. \"address\"         (string, required) The curvehash address to use for the private key.\n"
...
UniValue getreceivedbyaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The curvehash address for transactions.\n"
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 3 || request.params.size() > 6)
        throw std::runtime_error(
            ...
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a curvehash address."
            + HelpRequiringPassphrase(pwallet) + "\n"
            "\nArguments:\n"
            ...
            "                       the spend.\n"
            "2. \"toaddress\"         (string, required) The curvehash address to send funds to.\n"
            ...
            + HelpExampleCli("sendfrom", "\"\" \"PN9ZrKwPttJxM8VMsfBFtAWzbycpG2cosD\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"PN9ZrKwPttJxM8VMsfBFtAWzbycpG2cosD\" 0.01 6 \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"PN9ZrKwPttJxM8VMsfBFtAWzbycpG2cosD\", 0.01, 6, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            "    {\n"
            "      \"address\":amount   (numeric or string) The curvehash address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            "                           Those recipients will receive less curvehashs than you enter in their corresponding amount field.\n"
            ...
            + HelpExampleCli("sendmany", "\"\" \"{\\\"PKRWHSDPDZHFJ9Mrjy65fPN3wL8YWQrD8q\\\":0.01,\\\"PN9ZrKwPttJxM8VMsfBFtAWzbycpG2cosD\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"PKRWHSDPDZHFJ9Mrjy65fPN3wL8YWQrD8q\\\":0.01,\\\"PN9ZrKwPttJxM8VMsfBFtAWzbycpG2cosD\\\":0.02}\" 6 \"testing\"") +
            "\nSend two amounts to two different addresses, subtract fee from amount:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"PKRWHSDPDZHFJ9Mrjy65fPN3wL8YWQrD8q\\\":0.01,\\\"PN9ZrKwPttJxM8VMsfBFtAWzbycpG2cosD\\\":0.02}\" 1 \"\" \"[\\\"PKRWHSDPDZHFJ9Mrjy65fPN3wL8YWQrD8q\\\",\\\"PN9ZrKwPttJxM8VMsfBFtAWzbycpG2cosD\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"\", {\"PKRWHSDPDZHFJ9Mrjy65fPN3wL8YWQrD8q\":0.01,\"PN9ZrKwPttJxM8VMsfBFtAWzbycpG2cosD\":0.02}, 6, \"testing\"")
        );
    ...
    for (const std::string& name_ : keys) {
        ...
        if (!IsValidDestination(dest)) {
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Curvehash address: ") + name_);
        }
...
UniValue addmultisigaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 4) {
        std::string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" \"address_type\" )\n"
            ...
            "2. \"keys\"                         (string, required) A json array of curvehash addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"address\"                  (string) curvehash address or hex-encoded public key\n"
            "       ...,\n"
            "     ]\n"
            ...
            "}\n"
            "\nResult (DEPRECATED. To see this result in v0.8 instead, please start curvehashd with -deprecatedrpc=addmultisigaddress).\n"
            "        clients should transition to the new output api before upgrading to v0.9.\n"
            "\"address\"                         (string) A curvehash address associated with the keys.\n"

            "\nExamples:\n"
            "\nAdd a multisig address from 2 addresses\n"
            + HelpExampleCli("addmultisigaddress", "2 \"[\\\"PR5KAV1aTkHuscQ6FmdGEM7abGwfAAWwr5\\\",\\\"PN9ZrKwPttJxM8VMsfBFtAWzbycpG2cosD\\\"]\"") +
            "\nAs json rpc call\n"
            + HelpExampleRpc("addmultisigaddress", "2, \"[\\\"PR5KAV1aTkHuscQ6FmdGEM7abGwfAAWwr5\\\",\\\"PN9ZrKwPttJxM8VMsfBFtAWzbycpG2cosD\\\"]\"")
        ;
...
UniValue addwitnessaddress(const JSONRPCRequest& request)
{
    ...
    if (!IsDeprecatedRPCEnabled("addwitnessaddress")) {
        throw JSONRPCError(RPC_METHOD_DEPRECATED, "addwitnessaddress is deprecated and will be fully removed in v0.9. "
            "To use addwitnessaddress in v0.8, restart curvehashd with -deprecatedrpc=addwitnessaddress.\n"
...
UniValue listtransactions(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "    \"address\":\"address\",    (string) The curvehash address of the transaction. Not present for \n"
...
UniValue listsinceblock(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "    \"address\":\"address\",    (string) The curvehash address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "      \"address\" : \"address\",          (string) The curvehash address involved in the transaction\n"
...
UniValue walletpassphrase(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3) {
        throw std::runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending curvehash\n"
            "\nArguments:\n"
    ...
    // curvehash: if user OS account compromised prevent trivial sendmoney commands
    if (request.params.size() > 2)
        fWalletUnlockStakeOnly = request.params[2].get_bool();
    else
        fWalletUnlockStakeOnly = false;

    UniValue ret(UniValue::VOBJ);
    ret.push_back(Pair("unlocked_staking_only", fWalletUnlockStakeOnly));
...
UniValue encryptwallet(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1) {
        throw std::runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending curvehash\n"
    ...
    StartShutdown();
    return "wallet encrypted; Curvehash server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue lockunspent(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending curvehashs.\n"
...
UniValue getwalletinfo(const JSONRPCRequest& request)
{
    ...
    if (pwallet->IsCrypted()) {
        ...
        obj.push_back(Pair("unlocked_staking_only", fWalletUnlockStakeOnly));
    }
...
UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 5)
        throw std::runtime_error(
            ...
            "3. \"addresses\"      (string) A json array of curvehash addresses to filter\n"
            "    [\n"
            "      \"address\"     (string) curvehash address\n"
            "      ,...\n"
            "    ]\n"
            ...
            "    \"vout\" : n,               (numeric) the vout value\n"
            "    \"address\" : \"address\",    (string) the curvehash address\n"
            ...
            "\nExamples\n"
            + HelpExampleCli("listunspent", "")
            + HelpExampleCli("listunspent", "6 9999999 \"[\\\"PN9ZrKwPttJxM8VMsfBFtAWzbycpG2cosD\\\",\\\"PR5KAV1aTkHuscQ6FmdGEM7abGwfAAWwr5\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"PN9ZrKwPttJxM8VMsfBFtAWzbycpG2cosD\\\",\\\"PR5KAV1aTkHuscQ6FmdGEM7abGwfAAWwr5\\\"]\"")
    ...
    if (!request.params[2].isNull()) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!IsValidDestination(dest)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Curvehash address: ") + input.get_str());
            }
...
UniValue fundrawtransaction(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 3)
        throw std::runtime_error(
                            ...
                            "   {\n"
                            "     \"changeAddress\"          (string, optional, default pool address) The curvehash address to receive the change\n"
    ...
    if (!request.params[1].isNull()) {
      if (request.params[1].type() == UniValue::VBOOL) {
        ...
        if (options.exists("changeAddress")) {
            ...
            if (!IsValidDestination(dest)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "changeAddress must be a valid curvehash address");
            }
...
// curvehash: make a public-private key pair
...
// curvehash: display key pair from hex private key
...
// curvehash: reserve balance from being staked for network protection
