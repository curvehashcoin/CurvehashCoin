...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Curvehash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and curvehash: URIs)"));
...
//    connect(multisigAction, SIGNAL(triggered()), this, SLOT(gotoMultisigPage()));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Curvehash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Curvehash addresses"));
    ...
    openAction->setStatusTip(tr("Open a curvehash: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Curvehash command-line options").arg(tr(PACKAGE_NAME)));

    openChatroomAction = new QAction(QIcon(":/icons/curvehash"), tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open the Curvehash Discord in a web browser."));

    openForumAction = new QAction(QIcon(":/icons/curvehash"), tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open https://talk.curvehash.net in a web browser."));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Curvehash network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Curvehash"); // default title
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unlocked:
        ...
        labelWalletEncryptionIcon->setToolTip(fWalletUnlockStakeOnly? tr("Wallet is <b>encrypted</b> and currently <b>unlocked for block staking only</b>") : tr("Wallet is <b>encrypted</b> and currently <b>unlocked</b>"));
