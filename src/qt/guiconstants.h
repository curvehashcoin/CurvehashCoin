...
#define QAPP_ORG_NAME "Curvehash"
#define QAPP_ORG_DOMAIN "curvehash.net"
#define QAPP_APP_NAME_DEFAULT "Curvehash-Qt"
#define QAPP_APP_NAME_TESTNET "Curvehash-Qt-testnet"
